...
public final class BookmarkEvents {
    ...
    /**
     * The {@link com.jtechme.jumpgo.fragment.BookmarksFragment} want to know the url (and title)
    ...
    /**
     * Sended by the {@link com.jtechme.jumpgo.fragment.BookmarksFragment} when it wants to close
     * itself (generally in reply to a {@link com.jtechme.jumpgo.bus.BrowserEvents.UserPressedBack}
     * event.
     */
